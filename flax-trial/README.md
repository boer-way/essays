...
The Flax plant is very versitle. Flax varities can be grown and processed for many applications and adapt well to various conditions.  Examples include flax grown for textiles where bast fibers are processed and woven into linen fabric for clothing, sails for ships, flags, tents and string. Flax oil used in construction material such as pressing flax into "linseed oil".  Flax seeds for food are a omega rich powerhouse in which the seed provides a nutritional boost for many dietary applicaitons . Flax grows internationally and has been collected and used for these applications and many more for thousands of years. 
