...
The Flax plant is very versitle. Flax varities can be used and processed for many applications and adapts well to various conditions.  Examples include flax grown for textiles processed and woven into "linen fabric for clothing", sails for ships, flags, tents and string. Flax oil is used in construction for material applications such as processing flax into "linseed oil".  Flax seeds for food are a omega rich powerhouse the "Flax seed" provides a nutritional boost for many dietary applicaitons . Flax grows internationally and has been collected and used for these examples and more for thousands of years. 
